...
function IngredientInput() {
    ...
    const filteredRecipes = data.filter((recipe) => {
        ...
        const contientTags = selectedTags.length === 0 ||
        ...
        return (
            <div className="RecipeResults-card">
                ...
                <Link to={`/recipe/${props.id}`}>
                    <img src={props.url} className="RecipeResults-card-img" alt={props.title} />            </Link>
    ...
    return (
        <div className="encadrementIngredientInput">
            <div className='encadrementRecherche'>
                ...
                <p className='texteSousLogoInput'>Trouve-moi une recette !</p>
                ...
                <div>
                    ...
                    {/* ingredient a évité  */}
                    <p className='textIngredientSelect' >Ingrédients à éviter</p>
                    <div className='encradrementGarderIngredient'>
